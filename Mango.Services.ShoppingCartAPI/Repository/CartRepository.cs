...
namespace Mango.Services.ShoppingCartAPI.Repository
{
    public class CartRepository : ICartRepository
    {
        ...
        {
            var cartFromDb = _db.CartHeaders.FirstOrDefault(u => u.UserId == userId);
        ...
        public async Task<CartDto> CreateOrUpdateCart(CartDto cartDto)
        {
            ...
            //Check if product exist in the db, if not create it
            ...
            else
            {
                ...
                // if cart header is not null then update the count
                else
                {
                    cart.CartDetails.FirstOrDefault().Product = null;
